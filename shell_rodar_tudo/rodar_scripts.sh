...
#  PARAMETER :
#===============================================================================
for prev in 24 48 72 96 120 144 168
do
mestwo=JAN
ano_previ=2018
    echo "${prev}"
    echo "Inicio mergetime"
    cdo -r mergetime $dirout/${mestwo}${ano_previ}_${prev}Z_'*Z.nc' $dirout/${mestwo}${ano_previ}_${prev}Z.nc
    echo "Fim mergetime"
    echo "inicio media diaria"
    cdo -r dayavg $dirout/${mestwo}${ano_previ}_${prev}Z.nc $dirout/${mestwo}${ano_previ}_${prev}Z_diaria.nc
...
#  PARAMETER : 
#===============================================================================
for hr in 24 48 72 96 120 144 168
do
hora=${hr}
diain=1
diaout=31
